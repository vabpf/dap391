...
class ShopeeReviewScraper:
    ...
    def _fetch_reviews(self, offset, limit):
        ...
        print(f"Fetching {limit} reviews from {url}...")        
        try:
    ...
    def get_reviews(self, total_review):
        # get all reviews
        all_reviews = []
        offset = 0
        while offset < total_review:
            limit = min(50, total_review - offset)
...
# all_reviews = scraper.get_reviews(total_review=337)